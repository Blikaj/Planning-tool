...
public class Notebook extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case (R.id.btnDateTime):
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Notebook.this, Notebook.this, year, month, day);
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(Notebook.this, Notebook.this, hour, minute, DateFormat.is24HourFormat(this));
